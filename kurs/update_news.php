...
<?php
	...
	$arrayun = unserialize($rowtitle['array'.$_SESSION['lang']]);
?>
		...
		<div id="content">
			<?php
				if (!isset($id))
				{
					if ($_SESSION['lang']=='en')
					{
						$querynews="SELECT  id,nameen,author,date FROM news WHERE authorid='$_SESSION[user_id]'";
					}
					else
					{
