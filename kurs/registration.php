	...
	<div id="wrapper"> 
        ...
        <div id="content"> 
        	<form action="formdata.php" method="post" name="regForm" enctype="multipart/form-data">
				...
				<div class="inputdiv"><input class="input" type="text" name="login" id="login" /></div>
				...
				<div class="inputdiv"><input class="input" type="text" name="email" id="email" /></div>
				<div class="label"><label for="name"><?php echo $array['name']?>:</label></div>
				<div class="inputdiv"><input  class="input" type="text" name="name" id="name" /></div>
